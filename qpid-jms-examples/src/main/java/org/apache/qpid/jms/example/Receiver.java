        ...
        try {
            ...
            for (int i = 1; i <= count; i++, actualCount++) {
                ...
                if (message == null) {
                    ...
                    System.out.println("propertyExists "+message.propertyExists("JMS_AMQP_ContentType"));
                    System.out.println("propertyExists "+message.getStringProperty("JMS_AMQP_ContentType"));
                    System.out.println("propertyExists "+message.propertyExists("contentType"));
                    System.out.println("propertyValue "+message.getStringProperty("contentType"));
                    System.out.println("propertyValue "+message.getStringProperty("X_TRANSACTION_ID"));
                    //System.out.println("propertyValue "+message.);
                    //System.out.println("propertyValue "+message.getPropertyNames());
