...
#
# It assumes that the apache-activemq-5.11.0.redhat-621084.jar and 
...
java ${JAVA_OPTIONS} -cp ${ACTIVEMQ_HOME}/apache-activemq-5.11.0.redhat-621084.jar:${PERFHARNESS_HOME}/perfharness.jar JMSPerfHarness -pc JNDI -ii org.apache.activemq.jndi.ActiveMQInitialContextFactory -iu $BROKER_URL -cf ConnectionFactory -d dynamic$DESTINATION $@