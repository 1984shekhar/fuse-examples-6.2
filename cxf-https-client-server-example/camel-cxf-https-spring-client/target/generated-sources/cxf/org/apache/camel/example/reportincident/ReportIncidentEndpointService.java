 ...
 * 2016-09-07T09:55:13.678+01:00
 * Generated source version: 3.0.4.redhat-621084
 * 
 */
@WebServiceClient(name = "ReportIncidentEndpointService", 
                  wsdlLocation = "file:/local/testcase/01690852/camel-cxf-https-spring-client/src/main/resources/META-INF/wsdl/report_incident.wsdl",
...
public class ReportIncidentEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/local/testcase/01690852/camel-cxf-https-spring-client/src/main/resources/META-INF/wsdl/report_incident.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReportIncidentEndpointService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/local/testcase/01690852/camel-cxf-https-spring-client/src/main/resources/META-INF/wsdl/report_incident.wsdl");
        }
        WSDL_LOCATION = url;
    }
