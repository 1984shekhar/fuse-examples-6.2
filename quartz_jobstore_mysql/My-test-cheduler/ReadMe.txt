...
#Mysql
profile-edit --bundle wrap:file:/home/cpandey/NotBackedUp/Development/mysql-connector-java-5.1.34/mysql-connector-java-5.1.34-bin.jar quartzClusteredScheduler
container-list
container-remove-profile abc TestProfile 
profile-display quartzClusteredScheduler
 
profile-create --parent feature-camel quartzDB_interaction
profile-edit --bundle mvn:com.mycompany/oracle-datasource/1.0.0-SNAPSHOT quartzDB_interaction 
profile-edit --delete --bundle mvn:com.mycompany/oracle-datasource/1.0.0-SNAPSHOT quartzDB_interaction 
profile-edit --bundle mvn:com.mycompany/oracle-datasource/1.0.0-SNAPSHOT quartzDB_interaction 
profile-edit --bundle mvn:com.abc.test/my-quartz-scheduler/1.25.HA quartzDB_interaction 

profile-edit --bundle file:/NotBackedUp/cpandey/Downloads/My-test-cheduler/target/my-quartz-scheduler-1.25.HA.jar quartzDB_interaction 
