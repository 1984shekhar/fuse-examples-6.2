...
public class User extends AbstractSObjectBase {
    ...
    private Boolean UserPreferencesProcessAssistantCollapsed;

    @JsonProperty("UserPreferencesProcessAssistantCollapsed")
    public Boolean getUserPreferencesProcessAssistantCollapsed() {
        return this.UserPreferencesProcessAssistantCollapsed;
    }

    @JsonProperty("UserPreferencesProcessAssistantCollapsed")
    public void setUserPreferencesProcessAssistantCollapsed(Boolean UserPreferencesProcessAssistantCollapsed) {
        this.UserPreferencesProcessAssistantCollapsed = UserPreferencesProcessAssistantCollapsed;
    }
